...
ctx.keymap({
    ...
    'get checkout dev': 'git checkout dev \n',
    'get clone': 'git clone ',
    'get commit': ['git commit -m ""', Key('left')],
    'get commit no': ['git commit -m "" -n', Key('left'),Key('left'),Key('left'),Key('left')],
    'get simple commit': 'git add . && git commit -m "Update" \n',
    'get diff': 'git diff ',
    'get fetch': 'git fetch \n',
    'get grep': 'git grep ',
    'get in it': 'git init ',
    ...
    'get reset': 'git reset ',
    'get reset one commit': 'git reset HEAD~1 \n',
    'get reset one commit hard': 'git reset HEAD~1 --hard \n',
    'get show': 'git show ',
    'get status': 'git status \n',
    'get stash': 'git stash',
    'get stash pop': 'git stash pop \n',
    'get stash apply': 'git stash apply\n',
    'get tag': 'git tag ',
