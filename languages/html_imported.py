...
context = Context('html', bundle='com.microsoft.VSCode')
...
context.keymap({
    ...
    '(tag | ellie) custom <dgndictation>': ['<', text, '></', text, '>', Key('alt-left alt-left left left')],
    ...
    '(tag | ellie) div': CursorText('<div className={classes.{.}}></div>'),
